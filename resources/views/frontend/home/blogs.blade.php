            ...
            @forelse($blogs as $blog)
                <div class="col-lg-4 col-md-6">
                    <div class="package-card h-100 border rounded-3 overflow-hidden shadow-sm">
                        <img loading="lazy" src="{{ \App\Helpers\ImageHelper::webp($blog->getFirstMediaUrl('blogs')) ?: 'https://placehold.co/640x280?text=Blog+Image' }}" alt="{{ $blog->title }}" class="img-fluid w-100">
                        <div class="p-3">
