    ...
    <div class="top-bar py-2 border-bottom bg-white">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 d-none d-lg-block"><div class="d-flex justify-content-center gap-4 small text-dark"><div><i class="bi bi-telephone-fill text-success"></i> 0203 411 1934</div><div><i class="bi bi-phone-fill text-success"></i> 0738 088 8233</div><div><i class="bi bi-geo-alt-fill text-success"></i> High Wycombe, UK</div></div></div>
                <div class="col-lg-2 text-center text-lg-end"><a href="#quoteForm" class="btn btn-warning px-4 fw-semibold">Get a Quote</a></div>
            </div>
        </div>
    </div>
